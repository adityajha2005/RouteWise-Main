        ...
        <Dialog>
            ...
            <DialogContent className="text-white bg-black">
                <DialogHeader className="space-y-2 text-white">
                    <DialogTitle className="text-2xl text-white">Subscription</DialogTitle>
                </DialogHeader>
                <div className="flex flex-col gap-5">
                    <h4 className="text-lg text-white">Current Subscription</h4>
                ...
                <DialogFooter className="text-white">
                    <Button type="submit" className="border-2">Upgrade</Button>
                </DialogFooter>
            </DialogContent>
        </Dialog>
    )
